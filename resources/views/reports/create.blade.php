...
@section('header-content')
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-xl font-semibold text-gray-800">Rédiger un Rapport Journalier</h1>
    </div>
@endsection
...
<form action="{{ route('reports.store') }}" method="POST" class="mx-auto max-w-5xl space-y-8">
    @csrf
